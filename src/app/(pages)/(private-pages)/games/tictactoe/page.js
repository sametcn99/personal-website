...
export default function TicTacToe() {
  ...
  const status = winner ? `Winner: ${winner}` : isDraw ? 'Draw!' : `${xIsNext ? 'Computer\'s Turn' : 'Your Turn'}`; // Determine the game status message
  ...
  return (
    <main className="min-h-screen flex  items-center justify-center">
      <div className="w-60 mx-auto mt-10">
        <div className="mb-5 text-2xl font-bold select-none text-white">{status}</div>
