...
function parseFrontmatter(fileContent: string) {
  ...
  if (!match) {
    ...
    const title = titleMatch ? titleMatch[1] : "Untitled Gist";
...
export function getGistPosts() {
  return getMDXData(path.join(process.cwd(), "src", "content", "gists"));
}
