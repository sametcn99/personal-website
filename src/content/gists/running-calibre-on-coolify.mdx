...
This guide walks you through setting up and running on using . It focuses on
building a stable, persistent deployment with proper permissions and fully
...
At this stage, attempting to upload a book may result in a **“readonly
database”** or **“permission denied”** error. This occurs because the container
still lacks proper write access to the mounted volumes.
